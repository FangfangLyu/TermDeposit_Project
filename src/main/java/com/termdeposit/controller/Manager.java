...
public class Manager {
    ...
    public Manager() {
        ...
        this.view = new UserView(this); //userView will request action from the Model part so pass this object of the manager to UI
    ...
    public void startImputation(boolean isDefault, boolean isTraining, String trainingSetPath) throws Exception {
        ...
        try {
            //RandomForest forest = new RandomForest(this.data,randomSeed,treeNum,minDataToSplit,minDataToSplit,featureNum);
